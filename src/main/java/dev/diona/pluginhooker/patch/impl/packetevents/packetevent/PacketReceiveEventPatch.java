...
public class PacketReceiveEventPatch extends Patcher {
    ...
    public PacketReceiveEventPatch() {
        super("com.github.retrooper.packetevents.event.PacketReceiveEvent", "com.github.retrooper.packetevents.event.ProtocolPacketEvent");
    }
